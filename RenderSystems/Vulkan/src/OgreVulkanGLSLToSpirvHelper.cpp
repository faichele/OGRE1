...
namespace Ogre
{
    void OgreVulkanGLSLToSpirvHelper::Init()
    {
        //glslang::InitializeProcess();
    }

    void OgreVulkanGLSLToSpirvHelper::Finalize()
    {
        //glslang::FinalizeProcess();
    }

    void OgreVulkanGLSLToSpirvHelper::InitResources(TBuiltInResource &Resources)
    {
    ...
    EShLanguage OgreVulkanGLSLToSpirvHelper::FindLanguage(const VkShaderStageFlagBits shader_type)
    {
        switch (shader_type)
        {
    ...
    bool OgreVulkanGLSLToSpirvHelper::GLSLtoSPV(const VkShaderStageFlagBits shader_type, const char *pshader, std::vector<unsigned int> &spirv)
    {
